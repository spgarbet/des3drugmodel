...
save(results,file=paste0("/gpfs23/data/h_imph/gravesj/right/jonathan/raw_clo_newS_",num_seed,"_1y.rda")) #raw traj
# save(summ,file=paste0("/gpfs23/data/h_imph/gravesj/right/jonathan/summ_clo_newS_",num_seed,"_1y.rda"))
attributes <- attributes %>% dcast(name+strategy~key,value.var="value") 
save(attributes,file=paste0("/gpfs23/data/h_imph/gravesj/right/jonathan/at_clo_newS_",num_seed,"_1y.rda"))
...
save(out,file=paste0("/gpfs23/data/h_imph/gravesj/right/jonathan/cost_clo_newS_",num_seed,"_1y.rda"))
